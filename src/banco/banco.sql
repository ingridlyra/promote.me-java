...
CREATE TABLE T_PM_USUARIO(
	cd_login NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
INSERT INTO T_PM_CARREIRA(cd_carreira, nm_carreira)
VALUES (1, 'predero');

INSERT INTO T_PM_VAGA(cd_vaga, cd_carreira, nm_vaga)
VALUES (10, 1, 'PEDREIRO SENIOR');
...
INSERT INTO T_PM_FEEDBACK(cd_login, vl_feedback, ds_feedback, dt_envio, cd_login_receptor)
VALUES (1, 4, 'muit bom funcionario', TO_DATE('26-03-2008', 'dd-mm-yyyy'), 2);

SELECT * FROM T_PM_USUARIO;
SELECT * FROM T_PM_FEEDBACK;
